...
enum L {
    ...
    static var addCodexAccountSubtitle: String { text(ko: "사용 권한이 있는 계정만 저장", en: "Authorized accounts only") }
    ...
    static var usageReminder: String { text(ko: "5H 사용량 알림", en: "5H usage reminder") }
    static var usageReminderSubtitle: String { text(ko: "5H 잔여량이 설정값 이하일 때 알림", en: "Notify when 5H remaining is below the threshold") }
    static var reminderThreshold: String { text(ko: "알림 시점", en: "Reminder threshold") }
    static var remaining: String { text(ko: "5H 남았을 때", en: "5H remaining") }
    static var accountSuggestion: String { text(ko: "5H 전환 제안", en: "5H switch suggestion") }
    static var accountSuggestionSubtitle: String { text(ko: "5H 잔여량이 낮으면 전환 후보를 제안", en: "Suggest another account when 5H remaining is low") }
    ...
    static var attributionHistorySubtitle: String { text(ko: "계정별 사용량 연결 기록 삭제", en: "Clears usage-account mapping") }
    static var dashboardHistory: String { text(ko: "대시보드 사용량 데이터", en: "Dashboard usage data") }
    static var dashboardHistorySubtitle: String { text(ko: "집계 데이터만 삭제, 원본 로그 유지", en: "Clears aggregates only; logs stay") }
    ...
    static var menuBarTokens: String { text(ko: "토큰량", en: "Tokens") }
    static var menuBarCost: String { text(ko: "가격", en: "Cost") }
    ...
    static var todayShare: String { text(ko: "오늘 비중", en: "Today Share") }
