...
Add the Codex accounts you want to manage locally:

```sh
codex-auth login
```

Repeat the login flow for each account. If your accounts are already registered in `codex-auth`, you can skip this step.
